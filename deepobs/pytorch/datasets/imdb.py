...
class imdb(dataset.DataSet):
  ...
  """
    ...
    def _make_train_and_valid_dataloader(self):
        ...
        return self._make_dataloader(IMDBDataset(train_loader), shuffle = True), self._make_dataloader(IMDBDataset(valid_loader), shuffle=True)

    def _make_test_dataloader(self):
        return self._make_dataloader(IMDBDataset(self.test_dataloader))
